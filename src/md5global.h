 ...
 *
 * $Log: md5global.h,v $
 * Revision 1.1.1.1  2005/04/01 07:34:29  nobby
 *
 * Step 2 1st release version
 *    Copyright  Nobby N Hirano <nobby@aiware.co.jp>
 *
 *               Nobby Noboru Hirano <nobby@ntools.net> (Enigma encryption)
 *                                                      (libnsock)
 *               Other BSD group (rand functions)
 *
 * Revision 1.2  2005/03/08 07:22:43  nobby
 * *** empty log message ***
 *
